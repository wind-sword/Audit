...
"}")
        ...
        spacerItem3 = QtWidgets.QSpacerItem(20, 671, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"}")
    ...
    def retranslateUi(self, indexWindow):
        ...
        self.label_type.setText(_translate("indexWindow", "项目发文类型："))
        self.label_nhead.setText(_translate("indexWindow", "新增整改项目"))
        ...
        self.btprog.setText(_translate("indexWindow", "整改项目管理"))
        self.btproview.setText(_translate("indexWindow", "整改台账"))
        self.btproadd.setText(_translate("indexWindow", "新增整改项目"))
